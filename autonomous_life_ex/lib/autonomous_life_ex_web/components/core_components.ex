defmodule AutonomousLifeExWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AutonomousLifeExWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AutonomousLifeExWeb.Gettext, "errors", msg, opts)
    end
  end
